...
def CondaMisc():
    for scr in [
        f'curl -sLo {css} https://github.com/N3iKos/segsmaker-fast/raw/main/script/SM/segsmaker.css',
        f'curl -sLo {startup}/00-startup.py https://github.com/N3iKos/segsmaker-fast/raw/main/script/SM/00-startup.py',
        f'curl -sLo {startup}/util.py https://github.com/N3iKos/segsmaker-fast/raw/main/script/SM/util.py',
        f'curl -sLo {img} https://github.com/N3iKos/segsmaker-fast/raw/main/script/loading.png',
        f'curl -sLo {startup}/cupang.py https://github.com/N3iKos/segsmaker-fast/raw/main/script/cupang.py'
    ]: SyS(scr)
